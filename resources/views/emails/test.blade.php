...
<body>
    <div style="max-width: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ccc;">
        <h2>Welcome to Medlog Fleet Manager!</h2>
        <p>Hello {{ $user->name }},</p>
        ...
        <p>Please login using the provided credentials and consider changing your password after the first login for security reasons.</p>
